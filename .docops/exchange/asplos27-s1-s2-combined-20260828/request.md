# ASPLOS27 S1+S2 canonical pipeline combined audit

- task: asplos27-s1-s2-combined-20260828
- doc: asplos27-s1-s2-combined-20260828/request
- from: codex -> to: external-auditor
- executor: codex / auditor: external-model
- base commit: d7adec6
- created: 2026-08-28T04:49:35Z
...
S1 canonical CIBC closure plus S2 P-anchor coarse CROWN direct custom VJP closure

## Acceptance criteria

- AC1 source/build identity
- AC2 compiler/runtime structure
- AC3 three-way correctness
- AC4 six-fresh performance
- AC5 replay/tamper
- AC6 regressions/static quality
