# FSG4 B4-0 kernel attribution opportunity audit

- task: fsg4-b4-0-kernel-attribution-20260816
- doc: fsg4-b4-0-kernel-attribution-20260816/request
- from: codex -> to: external-model
- executor: codex / auditor: external-model
- base commit: 9adde46
- created: 2026-08-15T17:15:54Z
...
B4-0 formal raw attribution, replay, tamper, opportunity admission and claim boundary
...
- AC2 fresh semantic pair
- AC3 14-call phase closure
- AC4 opportunity calculation
- AC5 replay and outer-resigned tamper
- AC6 regression static and DocOps
- AC7 claim boundary and next-route admission
