...
36-process B0/B2/B3 artifact, independent ratios, replay, tamper, claim boundary

## Acceptance criteria

- AC1 source/input/protocol exact
- AC2 36 fresh workers and frozen sequence
- AC3 correctness and physical activation
- AC4 measurement admission
- AC5 independent ratio and classification recomputation
- AC6 replay tamper and frozen evidence
- AC7 claim boundary and downstream gate
