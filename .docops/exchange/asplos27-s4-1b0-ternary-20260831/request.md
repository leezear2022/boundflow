# S4-1B0 ternary endpoint formal correctness audit

- task: asplos27-s4-1b0-ternary-20260831
- doc: asplos27-s4-1b0-ternary-20260831/request
- from: codex-executor -> to: external-auditor
- executor: codex-executor / auditor: external-model
- base commit: 20f57bb
- created: 2026-08-31T02:43:10Z
...
isolated ternary endpoint implementation and formal correctness artifact only; no timing or performance

## Acceptance criteria

- AC1 source and protocol identity
- AC2 implementation semantics and stable negatives
- AC3 five-positive raw semantic recomputation
- AC4 cache and fault fresh execution
- AC5 stdlib replay and 10 coherent-resign attacks
- AC6 targeted full static and DocOps validation
- AC7 claim boundary and successor gating
