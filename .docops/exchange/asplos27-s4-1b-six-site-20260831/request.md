# ASPLOS27 S4-1B six-site production correctness

- task: asplos27-s4-1b-six-site-20260831
- doc: asplos27-s4-1b-six-site-20260831/request
- from: codex-executor -> to: external-auditor
- executor: codex / auditor: external-model
- base commit: 2f03905
- created: 2026-08-31T05:13:18Z
...
S4-1B ordered selector Pass A, 49-argument six-site Pass B, arena/stream/receipt ownership, production ResNet2B correctness; no S4-1C, timing, optimizer, or performance

## Acceptance criteria

- AC1: predecessor/order/scope and frozen construction contract
- AC2: real 19-action production Pass A and six compiled TIR selector packs
- AC3: exact 42-read+7-write Relax/TIR/cuDNN Pass B and content-derived identities
- AC4: coefficient/V arena, DLPack, result-owner, phase and stream ownership
- AC5: independent production ResNet2B six-slot numerical oracle
- AC6: negative gates, targeted/full regression and static checks
- AC7: no claim drift beyond S4-1B correctness
