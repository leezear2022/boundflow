# S4-1C compressed gradient and terminal lA correctness

- task: asplos27-s4-1c-gradient-20260831
- doc: asplos27-s4-1c-gradient-20260831/request
- from: codex -> to: external-auditor
- executor: codex / auditor: external-model
- base commit: 93915fe
- created: 2026-08-31T12:37:59Z
...
single-evaluation dα/dβ, 17/23-action Pass C, V/lA alias, fail-closed correctness; no timing or performance

## Acceptance criteria

- AC1 scope and gate order
- AC2 TIR math and invalid input
- AC3 module and ABI identity
- AC4 production 17/23 action order
- AC5 ownership and terminal handoff
- AC6 independent production correctness
- AC7 claim boundary
