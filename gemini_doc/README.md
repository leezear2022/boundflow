...
FSG4/B4-0 attribution已从source=`66154e4`完成正式artifact，内部状态=
`INTERNALLY-VALIDATED-B4-0-OPPORTUNITY-PENDING-EXTERNAL-AUDIT`。typed raw event、control/profile独立worker、
...
B4-C cumulative coverage与B4-D formal timing。当前下一唯一动作是外部审计；批准后只启动B4-A，
仍无B4 performance/B0 parity claim，B5—B7继续关闭。见
