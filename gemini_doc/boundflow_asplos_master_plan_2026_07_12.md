...
> **2026-07-28 进度修订**：上句是 2026-07-20 当时状态。IR-1 Bound IR 与 IR-2 Plan IR
> 的最小 reference contract 现已关闭；Schedule IR、runtime/backend migration 与 IR-driven
> E2E 仍未完成，当前下一阶段为 IR-3。详见
