...
> 只开放B2-5 formal independent-process correctness/artifact/replay/AB-BA timing；冻结ledger
> 不变且不得增加第13项。B4-B3仍关闭，B2-4不形成performance claim。
...
fallback/eager=`0/0`。外审已`APPROVE`且无blocker/major，B2-1关闭并只开放B2-2。
...
dense alpha/beta/scaled-A/relu-A global workspace。外审已`APPROVE`且无blocker/major，
B2-2关闭并只开放B2-3 P-anchor dense correctness，timing仍关闭。
