---
status: b4b2-b2-4-externally-approved-b2-5-open
...
> 只开放B2-5 formal independent-process correctness/artifact/replay/AB-BA timing；必须复用冻结
> 12项ledger，不得追加第13项。B4-B3仍关闭，当前仍无winner/performance claim。
