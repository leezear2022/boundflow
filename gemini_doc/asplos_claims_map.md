...
> **2026-08-16 FSG4/B4-0 Runner候选**：read-only profiler schema/runner已实现并通过12项B4、50项
> B3/B4相关及全量`1326 passed, 3 skipped`；raw保存operator/kernel/stream/shape/memory、明确记录
