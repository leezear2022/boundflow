...
| C2：Method/Autograd/Memory-Aware Materialization Planner | IR-4 closure；IR-5C3 fair architecture-held-out VALIDATED-NO-GO；IR-5D remediation calibration-only | typed PlanTemplate/PlanInstance、Task/Schedule lowering、adaptive/fair evaluator、prepared execution + calibration-only CUDA runner | 正式 Global 8/8 feasible，但相对 fair batched-original p50/p90 regret 68.065×/70.263×；旧 CNN remediation 诊断最快 median 0.880×/0.896×，不是 final | IR-5C3 有 MLP→CNN split、48 outcomes 与 replay；IR-5D 尚缺新 frozen residual final，性能 claim 仍失败 |
