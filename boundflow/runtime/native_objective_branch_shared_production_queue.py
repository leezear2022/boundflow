"""Production objective-branch queue without fixed-budget control replay."""
...
def execute_native_objective_branch_shared_production_queue(  # pylint: disable=too-many-statements
    ...
    *,
    ...
    """Execute objective branch scores inside the real shared queue budget."""
...
__all__ = ["execute_native_objective_branch_shared_production_queue"]
