"""NRIR-42 compile-owned scorer composed with the global anytime runtime."""
...
def execute_native_prevalidated_objective_branch_shared_multi_clause_anytime_program(  # pylint: disable=too-many-statements
