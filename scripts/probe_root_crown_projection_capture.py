#!/usr/bin/env python3
"""Capture one production root CROWN projection-residual transaction."""
...
from boundflow.runtime.root_crown_projection_capture import (  # noqa: E402
...
def _worker(args: argparse.Namespace) -> None:
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("root CROWN projection capture requires CUDA")
    capture = RootCrownProjectionCaptureV1()
    with tempfile.TemporaryDirectory(prefix="boundflow-root-projection-") as raw:
    ...
    torch.save(
        {
            "schema_version": "boundflow.root-crown-projection-tensors/v1",
