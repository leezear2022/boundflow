#!/usr/bin/env python3
"""Capture one production root CROWN residual-block transaction."""
...
from boundflow.runtime.root_crown_residual_capture import (  # noqa: E402
...
def _worker(args: argparse.Namespace) -> None:
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("root CROWN residual capture requires CUDA")
    capture = RootCrownResidualCaptureV1()
    with tempfile.TemporaryDirectory(prefix="boundflow-root-residual-") as raw:
    ...
    torch.save(
        {
            "schema_version": "boundflow.root-crown-residual-tensors/v1",
